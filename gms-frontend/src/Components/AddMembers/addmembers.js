...
const Addmembers=()=>{
    const [inputField, setInputField] = useState({ name: "", mobileNo: "", address: "", membership: "", profilePic: "https://image.freepik.com/free-icon/unknown-user-symbol_318-54178.jpg", joiningDate: ""});
        ...
        <div className='text-black'>
            <div className='grid gap-5 grid-cols-2 text-lg'>
                ...
                <div className='w-[100px] h-[100px]'>
                    <img src={inputField.profilePic} alt='? Upload pic' className='w-full h-full rounded-full' />
                    {
