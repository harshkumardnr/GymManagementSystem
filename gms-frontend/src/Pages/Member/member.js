    ...
    return (
        <div className='text-black p-5 w-3/4 h-[100vh]'>
            ...
            <div className='border-2 bg-slate-900 flex justify-between w-full text-white rounded-lg p-3'>
                <div className='border-2 pl-3 pr-3 pt-1 pb-1 rounded-2xl cursor-pointer hover:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500' onClick={() => handleMembers()}>Add Member <FitnessCenterIcon /></div>
            ...
            <div className='bg-slate-100 p-5 rounded-lg grid gap-2 grid-cols-3 overflow-x-auto h-[70%]'>
                {
                    data.map((item, index) => {
                        return (
